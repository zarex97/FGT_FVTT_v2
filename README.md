...
├── test/                  ← 4,491 unit and golden tests, no Foundry required
...
**4,491 tests passing**, covering everything built so far. They pin behaviour to the
...
```
npm install
npm test                  # 4,491 unit + golden tests, no Foundry required
