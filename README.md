...
├── test/                  ← 4,587 unit and golden tests, no Foundry required
...
**4,587 tests passing**, covering everything built so far. They pin behaviour to the
...
```
npm install
npm test                  # 4,587 unit + golden tests, no Foundry required
