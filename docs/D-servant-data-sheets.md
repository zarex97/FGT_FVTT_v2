...
**Scripts: 0.** Fully authored in `0.3.6`, and **every clause on this sheet has been seen working
on a live board**. Ch. 45 records the two passes and the ten defects they found -- six in shipped
machinery, three of those breaking every attack, every timed Command Spell, and every elemental
