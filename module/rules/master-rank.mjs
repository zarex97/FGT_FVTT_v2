 ...
 * @see docs/06-units-and-stats.md, docs/17-abilities.md, docs/33-command-spells.md
 *
 * Layer 2. Pure.
 *
 * The stored value is a LETTER (Ch. 06: Masters are A–D) because that is what a
 ...
 * A **Rankless** Master pays the cheaper Noble Phantasm price — Ch. 17:
...
/** The grades that count as High Rank (Ch. 06). */
 ...
 * with rules of its own rather than a missing value — Ch. 33 prices a table on
 ...
 * Parameters"* (Ch. 06). The summon dialog has always offered the CHOICE
